...
function bot_ui_ini() {
    ...
    botui.message.add({ delay: 800, content: "Hi, there👋" })
        .then(function() {
            botui.message.add({ delay: 1000, content: "这里是VivianYuan的博客🌻" })
                .then(function() {
                    botui.message.add({ delay: 800, content: "一个有想法的女孩子~" })
                        .then(function() {
                            botui.action.button({
                                    delay: 800,
    ...
    secondpart = function() {
        botui.message.add({ delay: 1000, content: "就读于同济大学" })
            .then(function() {
                botui.message.add({ delay: 1000, content: "是在信息安全专业学习的程序媛" })
                    .then(function() {
                        botui.message.add({ delay: 1200, content: "会迎合世俗的评判标准，也会忠于自己的内心" })
                            .then(function() {
                                botui.message.add({ delay: 1000, content: "会Python、C语言、matlab、html/css/javascript" })
                                    .then(function() {
                                        botui.message.add({ delay: 1000, content: "目前的研究方向是恶意流量识别" })
                                            .then(function() {
                                                botui.message.add({ delay: 1200, content: "目前在学托福和GRE,想要出国🎀" })
                                                    .then(function() {
                                                        botui.action.button({ delay: 1100, action: [{ text: "为什么想要出国呢？🤔", value: "why-mashiro" }] })
                                                            .then(function() { thirdpart() })
                                                    })
                                            })
                                    })
                            })
    ...
    thirdpart = function() {
        botui.message.add({ delay: 1e3, content: "世界这么大,我想去看看" })
            .then(function() {
                botui.action.button({
                        delay: 1500,
                        action: [{ text: "有没有什么兴趣爱好和喜欢的东西呢？🎀", value: "why-cat1" }]
                    })
                    .then(function() { fourthpart() })
            })
    };
    fourthpart = function() {
        botui.message.add({ delay: 1000, content: "喜欢看小说、电竞比赛，还有...钱？" })
            .then(function() {
                botui.message.add({
                        delay: 1100,
                        content: "在没找到自己真正想要的东西时,希望自己很有钱，哈哈哈"
                    })
                    .then(function() {
                        botui.action.button({
                                delay: 1500,
                                action: [{ text: "有个人照片吗🤗？", value: "why-domain" }]
                            })
                            .then(function() { fifthpart() })
                    })
            })
    };
    ...
    fifthpart = function() {
        botui.message.add({ delay: 1e3, content: "没有,真的没有🧐" })
            .then(function() {
                botui.action.button({
                        delay: 1000,
                        action: [{ text: "真的吗？🙄", value: "sure1" }, { text: "好吧！", value: "skip1" }]
                    })
                    .then(function(a) { "sure1" == a.value && sure1(); "skip1" == a.value && end1() })
            })
    };
    var sure1 = function() {
            botui.message.add({ delay: 1000, content: "😊" })
